                ...
                <div class="panel panel-default paper-shadow" data-z="0.5">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item media v-middle">
                            ...
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 9</a>
                            </div>
                        </li>
                        <li class="list-group-item media v-middle">
                            <div class="media-left">
                            ...
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 5</a>
                            </div>
                        </li>
                        <li class="list-group-item media v-middle">
                            <div class="media-left">
                            ...
                            <div class="media-right">
                                <a href="website-forum-thread.html" class="btn btn-white text-light"><i class="fa fa-comments fa-fw"></i> 13</a>
                            </div>
                        </li>
                    </ul>
                </div>
