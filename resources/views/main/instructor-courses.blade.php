        ...
        <div class="row">
                    ...
                    <div class="item col-xs-12 col-sm-6 col-lg-4">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="cover overlay cover-image-full hover">
                                ...
                                <a href="website-instructor-course-edit-course.html" class="padding-none overlay overlay-full icon-block bg-default">
                                    <span class="v-center">
            <i class="fa fa-github"></i>
        </span>
                                </a>
                                <a href="website-instructor-course-edit-course.html" class="overlay overlay-full overlay-hover overlay-bg-white">
                                    <span class="v-center">
            <span class="btn btn-circle btn-white btn-lg"><i class="fa fa-graduation-cap"></i></span>
                            ...
                            <div class="panel-body">
                                <h4 class="text-headline margin-v-0-10"><a href="website-instructor-course-edit-course.html">Github Webhooks for Beginners</a></h4>
                            </div>
                    ...
                    <div class="item col-xs-12 col-sm-6 col-lg-4">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="cover overlay cover-image-full hover">
                                ...
                                <a href="website-instructor-course-edit-course.html" class="padding-none overlay overlay-full icon-block bg-primary">
                                    <span class="v-center">
            ...
            <span class="btn btn-circle btn-primary btn-lg"><i class="fa fa-graduation-cap"></i></span>
                            ...
                            <div class="panel-body">
                                <h4 class="text-headline margin-v-0-10"><a href="website-instructor-course-edit-course.html">Awesome CSS with LESS Processing</a></h4>
                            </div>
                            <hr class="margin-none" />
                            <div class="panel-body">
                                <a class="btn btn-white btn-flat paper-shadow relative" data-z="0" data-hover-z="1" data-animated href="website-instructor-course-edit-course.html"><i class="fa fa-fw fa-pencil"></i> Edit course</a>
                    ...
                    <div class="item col-xs-12 col-sm-6 col-lg-4">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="cover overlay cover-image-full hover">
                                ...
                                <a href="website-instructor-course-edit-course.html" class="padding-none overlay overlay-full icon-block bg-lightred">
                                    <span class="v-center">
            ...
            <span class="btn btn-circle btn-red-500 btn-lg"><i class="fa fa-graduation-cap"></i></span>
                            ...
                            <div class="panel-body">
                                <h4 class="text-headline margin-v-0-10"><a href="website-instructor-course-edit-course.html">Vagrant Portable Environments</a></h4>
                            </div>
                            <hr class="margin-none" />
                            <div class="panel-body">
                                <a class="btn btn-white btn-flat paper-shadow relative" data-z="0" data-hover-z="1" data-animated href="website-instructor-course-edit-course.html"><i class="fa fa-fw fa-pencil"></i> Edit course</a>
                    ...
                    <div class="item col-xs-12 col-sm-6 col-lg-4">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="cover overlay cover-image-full hover">
                                ...
                                <a href="website-instructor-course-edit-course.html" class="padding-none overlay overlay-full icon-block bg-grey-200">
                                    <span class="v-center">
                ...
                <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
                    ...
                    <div class="panel-body list-group">
                        <ul class="list-group list-group-menu">
                            ...
                            <li class="list-group-item active"><a class="link-text-color" href="website-instructor-courses.html">My Courses</a></li>
