...
<div class="parallax cover overlay cover-image-full home">
    <img class="parallax-layer" src="{{url('/')."/plugins/images/photodune-4161018-group-of-students-m.jpg"}}" alt="Learning Cover" />
...
<div class="parallax cover overlay height-300 margin-none">
    <img class="parallax-layer" data-auto-offset="true" data-auto-size="false" src="{{url('/')."/plugins/images/photodune-6745579-modern-creative-man-relaxing-on-workspace-m.jpg"}}" alt="Learning Cover" />
            ...
            <div class="col-md-4">
                <div class="testimonial">
                    ...
                    <div class="media v-middle">
                        <div class="media-left">
                            <img src="" alt="People" class="img-circle width-40" />
                        </div>
                        <div class="media-body">
