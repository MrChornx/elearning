                ...
                <div class="item col-xs-12 col-sm-6 col-lg-4">
                    <div class="panel panel-default paper-shadow" data-z="0.5">
                        ...
                        <div class="cover overlay cover-image-full hover">
                            ...
                            <a href="/show-course/1" class="padding-none overlay overlay-full icon-block bg-default">
                                <span class="v-center">
                                    <i class="fa fa-github"></i>
                                </span>
                            </a>
                            <a href="/show-course/1" class="overlay overlay-full overlay-hover overlay-bg-white">
                                <span class="v-center">
                        ...
                        <div class="panel-body">
                            <h4 class="text-headline margin-v-0-10"><a href="/show-course/1">Github Webhooks for Beginners</a></h4>
                        </div>
                        <hr class="margin-none" />
                        <div class="panel-body">
                            <a class="btn btn-white btn-flat paper-shadow relative" data-z="0" data-hover-z="1" data-animated href="/show-course/1">Go to course</a>
                        </div>
                    </div>
                </div>
            </div>
