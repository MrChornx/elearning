                        ...
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-body">
                                <div class="pull-right">
                                    <a href="website-blog-post.html" class="btn btn-white btn-flat"><i class="fa fa-comments fa-fw"></i> 5</a>
                                </div>
                                <h4 class="text-title media-heading">
                                    <a href="website-blog-post.html" class="link-text-color">Am I learning the right way?</a>
                                </h4>
                ...
                <div class="media media-grid media-paper-shadow margin-top-none s-container">
                    ...
                    <div class="media-body">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-body">
                                <div class="pull-right">
                                    <a href="website-blog-post.html" class="btn btn-white btn-flat"><i class="fa fa-comments fa-fw"></i> 10</a>
                                </div>
                                <h4 class="text-title media-heading">
                                    <a href="website-blog-post.html" class="link-text-color">Can someone help me? I need a design advice</a>
                                </h4>
                                <p class="text-light text-caption">
                                    posted by
                                    <a href="#">
                ...
                <div class="media media-grid media-paper-shadow margin-top-none s-container">
                    ...
                    <div class="media-body">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-body">
                                <div class="pull-right">
                                    <a href="website-blog-post.html" class="btn btn-white btn-flat"><i class="fa fa-comments fa-fw"></i> 6</a>
                                </div>
                                <h4 class="text-title media-heading">
                                    <a href="website-blog-post.html" class="link-text-color">I think this is the right way?</a>
                                </h4>
                                <p class="text-light text-caption">
                                    posted by
                                    <a href="#">
                ...
                <div class="media media-grid media-paper-shadow margin-top-none s-container">
                    ...
                    <div class="media-body">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-body">
                                <div class="pull-right">
                                    <a href="website-blog-post.html" class="btn btn-white btn-flat"><i class="fa fa-comments fa-fw"></i> 14</a>
                                </div>
                                <h4 class="text-title media-heading">
                                    <a href="website-blog-post.html" class="link-text-color">Getting around AngularJS</a>
                                </h4>
                                <p class="text-light text-caption">
                                    posted by
                                    <a href="#">
                ...
                <div class="media media-grid media-paper-shadow margin-top-none s-container">
                    ...
                    <div class="media-body">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-body">
                                <div class="pull-right">
                                    <a href="website-blog-post.html" class="btn btn-white btn-flat"><i class="fa fa-comments fa-fw"></i> 11</a>
                                </div>
                                <h4 class="text-title media-heading">
                                    <a href="website-blog-post.html" class="link-text-color">Responsive Bootstrap Question</a>
                                </h4>
                                <p class="text-light text-caption">
                                    posted by
                                    <a href="#">
                ...
                <div class="media media-grid media-paper-shadow margin-top-none s-container">
                    ...
                    <div class="media-body">
                        <div class="panel panel-default paper-shadow" data-z="0.5">
                            <div class="panel-body">
                                <div class="pull-right">
                                    <a href="website-blog-post.html" class="btn btn-white btn-flat"><i class="fa fa-comments fa-fw"></i> 7</a>
                                </div>
                                <h4 class="text-title media-heading">
                                    <a href="website-blog-post.html" class="link-text-color">Responsive Bootstrap Question</a>
                                </h4>
