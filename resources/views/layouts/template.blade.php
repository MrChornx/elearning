...
<head>
    ...
    <link href="{{url('/')."/plugins/css/vendor.min.css"}}" rel="stylesheet">
...
<body>
 <!-- Wrapper required for sidebar transitions -->
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="main-nav">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">{{ trans('main.header.courses') }} <span class="caret"></span></a>
                            <ul class="dropdown-menu">
    ...
    <script src="{{url('/')."/plugins/js/vendor-core.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-countdown.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-tables.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-forms.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-carousel-slick.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-player.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-charts-flot.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/vendor-nestable.min.js"}}"></script>
    ...
    <script src="{{url('/')."/plugins/js/module-essentials.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/module-material.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/module-layout.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/module-sidebar.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/module-carousel-slick.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/module-player.min.js"}}"></script>
    <script src="{{url('/')."/plugins/js/module-messages.min.js"}}"></script>
    <!-- <script src="{{url('/')."/plugins/js/module-maps-google.min.js"}}"></script> -->
    <script src="{{url('/')."/plugins/js/module-charts-flot.min.js"}}"></script>
